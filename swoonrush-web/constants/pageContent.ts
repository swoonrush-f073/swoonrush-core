...
export const HERO_EXTRA_CONTENT = {
  floatingBadge: 'Inspired by the stories we love ❤️',
  features: {
    feature1: 'Premium Cotton',
    feature2: 'Exclusive Designs',
    feature3: 'Unisex Fit',
    feature4: 'Perfect for Fans',
  },
};
